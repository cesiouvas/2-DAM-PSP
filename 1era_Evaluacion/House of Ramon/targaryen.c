...
int main(int argc, char *argv[]) {
	...
	//Cierro el fifo de escritura arriba

	//ABRIR FIFO MODO LECTURA = 0
	...
	switch (pid1){
		...
		case 0:
			...
			//SEGUNDA ESPOSA AGENCIA MARTELL ESCRITURA
			...
			//CERRAR FIFO ESCRITURA Y ABRIR COMO LECTURA
